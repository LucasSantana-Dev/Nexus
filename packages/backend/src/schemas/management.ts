...
const autoModSettingsBody = z
    .object({
        ...
        spamInterval: z.number().int().min(1000).max(60000).optional(),
        ...
        whitelistedLinks: z.array(z.string().max(200)).optional(),
        invitesEnabled: z.boolean().optional(),
        allowOwnInvites: z.boolean().optional(),
        wordsEnabled: z.boolean().optional(),
        badWords: z.array(z.string().max(100)).optional(),
